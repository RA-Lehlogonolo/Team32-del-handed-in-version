...
namespace INF_370.Group_32.ASP.NETCore.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "INF_370.Group_32.ASP.NETCore.API", Version = "v1" });
            });
        }
            ...
            )
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "INF_370.Group_32.ASP.NETCore.API v1"));
            }
