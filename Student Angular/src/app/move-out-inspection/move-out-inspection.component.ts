...
@Component({
  selector: 'app-move-out-inspection',
  templateUrl: './move-out-inspection.component.html',
  styleUrls: ['./move-out-inspection.component.css']
})
export class MoveOutInspectionComponent implements OnInit {
  ...
  handleOkAddRequest(): void {
    ...
    this.notification.create('success', '', 'Successfully completed move-out inspection!',
      {
        nzStyle: { backgroundColor: 'green', color: 'white' },
        nzClass: ''
      }
